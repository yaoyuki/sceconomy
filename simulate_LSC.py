...
if __name__ == '__main__':
    ...
    w_ = 3.1137868340256523
    p_ = 0.7144015309115987
    rc_ = 0.063809669220426
    ...
    econ = Economy(zgrid = zgrid2*0.45, prob = prob2, path_to_data_i_s = './input_data/data_i_s_0709_01_0075')
