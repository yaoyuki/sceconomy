...
from SCEconomy_bizmkt_nzprofit_give_A import Economy
...
prices_init = [w_init, p_init, rc_init, pkap_init]


nd_log_file = '/home/ec2-user/Dropbox/case2/log.txt'
detailed_output_file = '/home/ec2-user/Dropbox/case2/detailed_output.txt'
...
def target(prices):
    ...
    result = subprocess.run(['mpiexec', '-n', num_core, 'python', 'SCEconomy_bizmkt_nzprofit_give_A.py'], stdout=subprocess.PIPE)
    t1 = time.time()
    ...
    dist = np.sqrt(moms[0]**2.0 + moms[1]**2.0 + moms[2]**2.0 + moms[5]**2.0)
